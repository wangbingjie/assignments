...
public class Blackjack {
    ...
    public static void main(String[] args) throws IOException {
      ...
      if (choice.equalsIgnoreCase("Y")) {
        ...
        while (!sc.hasNext("H") && !sc.hasNext("h") && !sc.hasNext("Hit") && !sc.hasNext("hit")
        && !sc.hasNext("S") && !sc.hasNext("s") && !sc.hasNext("Stay") && !sc.hasNext("stay")) {
          System.out.print("[H]it or [S]tay? > ");
          sc.next();
        }
        String action = sc.next();

        while ( action.equalsIgnoreCase("H") || action.equalsIgnoreCase("Hit") ) {
        ...
        if (score <= 21) {
          ...
          System.out.print(cDealer.toString());
